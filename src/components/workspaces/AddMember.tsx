    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <form>
        <DialogTrigger asChild>
          <button className="flex items-center w-full p-2 rounded-md text-sm text-gray-700 hover:bg-gray-100">
            <svg
        ...
        <DialogContent className="sm:max-w-[425px] bg-white border-none">
          <DialogHeader>
            ...
            <DialogDescription>
              Search for a user and assign them a role in your workspace.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            {addError && (
              <span className="text-red-600">{addError?.response.data}</span>
            )}
