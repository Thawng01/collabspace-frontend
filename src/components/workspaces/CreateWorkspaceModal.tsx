        ...
        <DialogTrigger asChild>
          {workspace ? (
            <button
              ...
              //     setIsMenuOpen(false);
              // }}
              className="flex items-center w-full p-2 rounded-md text-sm text-gray-700 hover:bg-gray-100"
            >
              <svg
        ...
        <DialogContent className="sm:max-w-[425px] bg-white border-0">
          <DialogHeader>
            ...
            <DialogDescription className="text-[gray]">
              {workspace ? "Update" : "Create"}your space and start your journey
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            ...
            <div className="grid gap-3">
              <Label htmlFor="description">
                Description <span className="text-[gray]">(Option)</span>
              </Label>
              <input
                className="focus:outline-0 focus:ring-1 focus:ring-blue-400 border-1 focus:border-0 rounded-md py-2 px-3"
                id="description"
