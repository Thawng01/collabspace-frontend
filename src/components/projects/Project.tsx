...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({ workspaces }) => {
    ...
    const { data: projects } = useFetchWithParam(`/projects`, {
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <CreateProjectModal params={selectedWorkspace} />
                </div>
